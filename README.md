...
![Toy Factory](docs/gallery/14-toy-factory.png)

**Toy Factory** — **塑料材质（首个双瓣混合 BSDF）**：五只糖果色 Sparky
玩具的壳体是漫反射底 + GGX 电介质涂层，涂层粗糙度逐只递增——相机后方
灯管的反射条从清漆锐线一路糊成哑光平晕；中间那只被质检唤醒，屏幕以
纹理发光网格点亮同伴。

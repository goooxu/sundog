...
| ![Bunny Atrium](docs/gallery/03-bunny-atrium.png) | ![Bunny Swarm](docs/gallery/05-bunny-swarm.png) |
|:---:|:---:|
| **Bunny Atrium** — 硬件三角形，14.4 万面 ×3 | **Bunny Swarm** — 4096 实例 ≈5.9 亿等效三角形 |

| ![32 spp 原始](docs/gallery/03-bunny-atrium-spp32-raw.png) | ![32 spp + AI 降噪](docs/gallery/03-bunny-atrium-spp32-denoised.png) |
|:---:|:---:|
...
- **几何**：5 种 quadric（sphere / rect / disk / cylinder / parabola）自定义求交
  + 硬件三角形网格（OBJ，可平滑法线）；单层 IAS 实例化，支持非均匀缩放
...
scenes/       场景 JSON + 纹理
assets/       网格资产（bunny.obj，来源见 assets/LICENSES.md）

...
![PSNR 随 spp 的收敛曲线](figures/ch03-mc-convergence.avif)

*图：PSNR(dB) 与 spp（对数轴）的关系，虚线为 +6dB/4× 理论参考斜率。*

主观感受可回看[第 1 章·成像与光线](01-images-and-rays.md)的 spp 五联图（figures/ch01-spp-convergence.avif）：1→4→16 spp 的改善肉眼可见，64→256 就只剩细微差别——收敛在对数尺度上是"匀速"的，在线性尺度上越来越慢。

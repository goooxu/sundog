...
|---|---|---|
| $`f_r`$ | 材质四类：MT_LAMBERT / MT_METAL / MT_DIELECTRIC / MT_WATER（水在 BSDF 层与电介质共享分支，见第 13 章；`MaterialDesc`，device/params.h），求值入口 `bsdfEval()`（device/bsdf.cuh） | [第 5 章](05-materials.md) |
